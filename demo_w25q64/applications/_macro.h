...
#define STM32_PAGE_SIZE								   64
#define STM32_B_PAGE_SIZE								 20
#define STM32_A_PAGE_SIZE								 (STM32_PAGE_SIZE-STM32_B_PAGE_SIZE)
#define STM32_B_PAGE_ADDR								 0x08000000
#define STM32_A_PAGE_ADDR								 STM32_B_PAGE_ADDR+(STM32_B_PAGE_SIZE*1024)

/*BOOTLOADER*/
#define BOOTLOART_LOG
/*OTA*/
#define OTA_FLAG 					0xab
...
/*serial*/
#define serial_1_rx_buf_size 							 1024
...
#define _serial_rx_th_stack_size            2048
